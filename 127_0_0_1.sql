...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 30-07-2021 a las 21:16:40
...
--
-- Base de datos: `appvilla`
--
CREATE DATABASE IF NOT EXISTS `appvilla` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `appvilla`;
...
CREATE TABLE `tbalmacen` (
  ...
  `userid_on` int(11) NOT NULL,
  `fecha_on` datetime NOT NULL,
  `userid_md` int(11) DEFAULT NULL,
...
INSERT INTO `tbalmacen` (`id`, `empresa_id`, `nombre`, `descripcion`, `direccion`, `telefono`, `email`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 2, 'almacen1', 'almacen 01', 'Av. las palmas', '99999999999', NULL, 1, 1, '2021-03-29 22:57:13', NULL, NULL, NULL),
(2, 2, 'almacen2', 'almacen 02', 'Av. las palmas 123', '99999999999', NULL, 1, 1, '2021-03-29 22:57:13', NULL, NULL, NULL),
(3, 2, 'almacen3', 'almacen 03', 'Av. las palmas 124', '99999999999', NULL, 1, 1, '2021-03-29 22:57:13', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbbasicos`
--

CREATE TABLE `tbbasicos` (
  `id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `tbbasicos`
--

INSERT INTO `tbbasicos` (`id`, `parentid`, `codigo`, `sigla`, `nombre`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 0, '0', '', 'TipoIdentificaciones', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(2, 1, '1', 'DNI', 'Documento nacional de identidad', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(3, 1, '6', 'RUC', 'REGISTRO UNICO DE CONTRIBUYENTE', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(4, 1, '4', 'CE', 'CARNET DE EXTRANJERIA', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(5, 1, '7', 'PS', 'PASAPORTE', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(6, 1, '11', 'PN', 'PART. DE NACIMIENTO-IDENTIDAD', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(7, 1, '00', 'OT', 'OTROS', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(8, 0, '0', '', 'Modalidad Pago', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(9, 8, '1', 'C', 'Contado', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(10, 8, '2', 'R', 'Credito', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(11, 8, '3', 'G', 'Gratuito', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(12, 0, '0', '', 'Tipo de Comprobantes', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(13, 12, '1', '', 'Factura', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(14, 12, '3', '', 'Boleta', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(15, 12, '7', '', 'Nota Credito', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(16, 12, '8', '', 'Nota Debito', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(17, 0, '0', '', 'Perfil', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(18, 17, '1', '0', 'Ssistema', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(19, 17, '2', '0', 'Gestor', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(20, 17, '3', '1', 'Cliente administrador', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(21, 17, '4', '1', 'Vendedor', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(22, 17, '5', '1', 'Cajera', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(23, 17, '6', '1', 'Vendedor Cajera', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(24, 17, '7', '1', 'Almacenero', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL),
(25, 12, '99', '', 'Nota de pedido', 1, 1, '2021-04-21 03:37:16', 1, '2021-06-30 22:22:17', NULL),
(26, 0, '0', '', 'Presentacion', 1, 1, '2021-04-21 03:52:45', 1, '2021-04-21 04:47:54', NULL),
(27, 26, '', 'niu', 'Unidad', 1, 1, '2021-02-28 00:59:17', 1, '2021-04-24 01:15:40', NULL),
(28, 26, '', 'kg', 'Kilo Gramo', 1, 1, '2021-04-24 01:08:47', 1, '2021-04-24 01:15:48', NULL),
(29, 26, '', 'ltr', 'Litro', 1, 1, '2021-04-24 01:17:56', NULL, NULL, NULL),
(30, 26, '', 'bx', 'Caja', 1, 1, '2021-04-24 01:18:28', NULL, NULL, NULL),
(31, 26, '', 'mtr', 'Metro', 1, 1, '2021-04-24 01:18:55', NULL, NULL, NULL),
(32, 26, '', 'zz', 'Servicio', 1, 1, '2021-04-24 01:19:13', NULL, NULL, NULL);
...
CREATE TABLE `tbcajas` (
  ...
  `tipocambio` decimal(8,2) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `tbcajasdet`
--

CREATE TABLE `tbcajasdet` (
  `id` int(11) NOT NULL,
  `cajacab_id` int(11) NOT NULL,
  `empresa_id` int(11) NOT NULL,
  `tipomovimiento_id` int(11) NOT NULL,
  `moneda_id` int(11) NOT NULL,
  `monto` decimal(8,2) DEFAULT NULL,
  `tipocomrobante_id` int(11) DEFAULT NULL,
...
INSERT INTO `tbcargos` (`id`, `empresa_id`, `sigla`, `nombre`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 2, '', 'Ejecutivo Comercial', 1, 1, '2021-04-05 20:21:16', NULL, NULL, NULL);
...
INSERT INTO `tbcategoria` (`id`, `empresa_id`, `nombre`, `descripcion`, `color`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 2, 'abarrotes', NULL, '#FC180C', 1, 1, '2021-03-05 21:47:25', NULL, NULL, NULL),
(2, 2, 'bebidas', NULL, '#80D80D', 1, 1, '2021-03-05 21:47:25', NULL, NULL, NULL),
(3, 2, 'test', '', '#fafafa', 1, 2, '2021-04-26 00:06:32', 2, '2021-04-26 00:16:39', NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbclientemodalidadpago`
--

CREATE TABLE `tbclientemodalidadpago` (
  `id` int(11) NOT NULL,
  `cliente_id` int(11) DEFAULT NULL,
  `modalidadpago_id` int(11) DEFAULT NULL,
  `enabled` tinyint(1) DEFAULT 1,
  `userid_on` int(11) NOT NULL,
  `fecha_on` datetime NOT NULL,
  `userid_md` int(11) DEFAULT NULL,
...
CREATE TABLE `tbclientes` (
  ...
  `contacto` varchar(199) DEFAULT NULL,
  `pais_code` varchar(2) DEFAULT NULL,
  `departamento_code` varchar(2) DEFAULT NULL,
  `provincia_code` varchar(4) DEFAULT NULL,
  `distrito_code` varchar(6) DEFAULT NULL,
  `lineacredito` decimal(18,2) DEFAULT NULL,
  `enabled` tinyint(1) DEFAULT 1,
  `userid_on` int(11) NOT NULL,
  `fecha_on` datetime NOT NULL,
  `userid_md` int(11) DEFAULT NULL,
...
INSERT INTO `tbclientes` (`id`, `empresa_id`, `tipoidentificacion_id`, `numero_identificacion`, `razon_social`, `nombres`, `apellidos`, `direccion`, `email`, `telefono`, `contacto`, `pais_code`, `departamento_code`, `provincia_code`, `distrito_code`, `lineacredito`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 2, 6, '10422649358', 'ronald ramos gutierrez', NULL, NULL, 'av. las lomas 194', 'rramos@r2g.com', NULL, '', 'PE', '15', '1501', '150103', NULL, 1, 1, '2021-02-28 09:28:45', NULL, NULL, NULL),
(2, 2, 1, '42264935', 'ramos gutierrezronald', 'ronald', 'ramos gutierrez', 'av. las palmas', 'ronald1781@gmail.com', '9236592456', 'ronald ramos', 'PE', '15', '1501', NULL, NULL, 1, 2, '0000-00-00 00:00:00', NULL, NULL, NULL),
(3, 2, 6, '10422649358', 'ronald ramos sac', '', '', 'av peru 1234', 'ronald1781@outlook.com', '9236592456', 'ronald ramos', 'PE', '11', '1105', NULL, NULL, 1, 2, '0000-00-00 00:00:00', NULL, NULL, NULL),
(4, 2, 1, '42265395', 'ramos gutierrezronald', 'ronald', 'ramos gutierrez', 'av. las palmas', 'ronald1781@outlook.com', '9236592456', '', 'PE', '10', '1008', '', NULL, 1, 2, '0000-00-00 00:00:00', NULL, NULL, NULL);
...
INSERT INTO `tbcolaboradores` (`id`, `empresa_id`, `tipoidentificacion_id`, `numero_identificacion`, `nombres`, `apellidos`, `direccion`, `email`, `telefono`, `pais_code`, `departamento_code`, `provincia_code`, `distrito_code`, `cargo_id`, `user_id`, `local_id`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 2, 1, '42264935', 'ronald', 'ramos', 'av. las lomas 194', NULL, NULL, NULL, NULL, NULL, NULL, 1, 2, 1, 1, 1, '2021-03-06 06:17:36', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbcomprascab`
--

CREATE TABLE `tbcomprascab` (
  `id` int(11) NOT NULL,
  `empresa_id` int(11) NOT NULL,
  ...
  `pais_code` varchar(3) DEFAULT NULL,
  `departamento_code` varchar(2) DEFAULT NULL,
  `provincia_code` varchar(4) DEFAULT NULL,
  `distrito_code` varchar(6) DEFAULT NULL,
  ...
  `fecha_comprobante` varchar(10) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `tbcomprasdet`
--

CREATE TABLE `tbcomprasdet` (
  `id` int(11) NOT NULL,
  `empresa_id` int(11) NOT NULL,
...
INSERT INTO `tbdepartamentos` (`id`, `name`) VALUES
('01', 'Amazonas'),
('02', 'Áncash'),
('03', 'Apurímac'),
('04', 'Arequipa'),
...
--
-- Estructura de tabla para la tabla `tbdistritos`
--
...
--
-- Volcado de datos para la tabla `tbdistritos`
--

INSERT INTO `tbdistritos` (`id`, `name`, `provincia_id`, `departamento_id`) VALUES
...
--
-- Estructura de tabla para la tabla `tbempresamonedas`
--

CREATE TABLE `tbempresamonedas` (
  `id` int(11) NOT NULL,
  `userid_on` int(11) NOT NULL,
  `fecha_on` timestamp NOT NULL DEFAULT current_timestamp(),
  `userid_md` int(11) DEFAULT NULL,
  `fecha_md` int(11) DEFAULT NULL,
  `fecha_del` int(11) DEFAULT NULL,
  `empresa_id` int(11) NOT NULL,
  `moneda_id` int(11) NOT NULL,
  `principal` tinyint(1) NOT NULL COMMENT '1=principal',
  `enabled` tinyint(1) NOT NULL DEFAULT 1
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Volcado de datos para la tabla `tbempresamonedas`
--

INSERT INTO `tbempresamonedas` (`id`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`, `empresa_id`, `moneda_id`, `principal`, `enabled`) VALUES
(1, 1, '2021-06-13 16:00:54', NULL, NULL, NULL, 2, 1, 1, 1),
(2, 1, '2021-06-13 16:00:54', NULL, NULL, NULL, 2, 2, 0, 1);
...
CREATE TABLE `tbempresas` (
  `id` int(11) NOT NULL,
  `tipoidentificacion_code` int(11) NOT NULL,
  `numero_identificacion` varchar(15) NOT NULL,
  `razon_social` varchar(80) DEFAULT NULL,
  `direccion` varchar(45) DEFAULT NULL,
  `email` varchar(45) DEFAULT NULL,
...
INSERT INTO `tbempresas` (`id`, `tipoidentificacion_code`, `numero_identificacion`, `razon_social`, `direccion`, `email`, `telefono`, `pais_code`, `departamento_code`, `provincia_code`, `distrito_code`, `contacto`, `logo`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 6, '20101759688', 'EMPRESA SAc', 'av. huaylas 120', '', '', NULL, '04', '0402', '040207', '', '1624817359407.PNG', 1, 1, '2021-02-28 00:59:17', NULL, '2021-06-27 13:09:19', NULL),
(2, 6, '10987654321', 'mym', 'av. nicolas arriola1723', 'ronald1781@mym.com', '95123456', NULL, '12', '1201', '120101', 'Ronald ramos', '1616348134773.PNG', 1, 1, '0000-00-00 00:00:00', NULL, '2021-03-21 12:35:34', NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbgenerales`
--

CREATE TABLE `tbgenerales` (
  `id` int(11) NOT NULL,
  `empresa_id` int(11) NOT NULL,
  ...
  `nombrelargo` varchar(150) DEFAULT NULL,
  `enabled` tinyint(1) DEFAULT 1,
  `userid_on` int(11) NOT NULL,
  `fecha_on` datetime NOT NULL,
  `userid_md` int(11) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `tbgestorsoft`
--

CREATE TABLE `tbgestorsoft` (
  `id` int(11) NOT NULL,
  `nombre_gestor` varchar(80) DEFAULT NULL,
  `tipdocumento_id` int(11) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `tbgestorsoft`
--

INSERT INTO `tbgestorsoft` (`id`, `nombre_gestor`, `tipdocumento_id`, `numero_documento`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 'APPVILLA', 2, '12345678910', 1, 1, '2021-02-28 00:59:17', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbinventariocab`
--

CREATE TABLE `tbinventariocab` (
  `id` int(11) NOT NULL,
  `empresa_id` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `tbinventariodet`
--

CREATE TABLE `tbinventariodet` (
  `id` int(11) NOT NULL,
  `inventariocab_id` int(11) NOT NULL,
  `producto_id` int(11) NOT NULL,
  `saldo_inicial` decimal(8,2) NOT NULL,
  `entrada` decimal(8,2) DEFAULT NULL,
  `salida` decimal(8,2) DEFAULT NULL,
...
CREATE TABLE `tbkardex` (
  ...
  `tipocomprobante_id` int(11) NOT NULL,
  `nrumorocomprobante` varchar(15) DEFAULT NULL,
  `entrada` decimal(8,2) DEFAULT NULL,
  `salida` decimal(8,2) DEFAULT NULL,
  `enabled` tinyint(1) DEFAULT 1,
  `userid_on` int(11) NOT NULL,
...
INSERT INTO `tbmarca` (`id`, `empresa_id`, `nombre`, `descripcion`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 2, 'cusqueña', NULL, 1, 1, '2021-03-05 21:45:53', NULL, NULL, NULL),
(2, 2, 'inca kola', NULL, 1, 1, '2021-03-05 21:45:53', NULL, NULL, NULL),
(3, 2, 'trujillo', NULL, 1, 1, '2021-03-05 21:45:53', NULL, NULL, NULL),
(4, 2, 'cristal', '', 1, 1, '2021-03-05 21:45:53', 2, '2021-04-26 02:30:06', NULL),
(5, 2, 'pilsen', NULL, 1, 1, '2021-03-05 21:45:53', NULL, NULL, NULL),
(6, 2, 'costeño', NULL, 1, 1, '2021-03-05 21:45:53', NULL, NULL, NULL),
(7, 2, 'test', '', 1, 2, '2021-04-26 02:28:46', NULL, NULL, NULL),
(8, 2, 'test', '', 1, 2, '2021-04-26 10:35:31', NULL, NULL, NULL),
(9, 2, 'r2g', '', 1, 2, '2021-04-26 10:37:48', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbmodulos`
--
...
--
-- Volcado de datos para la tabla `tbmodulos`
--

INSERT INTO `tbmodulos` (`id`, `flag`, `parent_id`, `nombre`, `link`, `orden`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 1, 0, 'Principal', NULL, 0, 1, 1, '2021-02-28 09:47:41', NULL, NULL, NULL),
(2, 1, 0, 'Ventas', NULL, 1, 1, 1, '2021-02-28 09:47:41', NULL, NULL, NULL),
(3, 1, 0, 'Compras', NULL, 2, 1, 1, '2021-02-28 09:47:41', NULL, NULL, NULL),
(4, 1, 0, 'Almacen', NULL, 3, 1, 1, '2021-02-28 09:47:41', NULL, NULL, NULL),
(5, 1, 0, 'Caja', NULL, 4, 1, 1, '2021-02-28 09:47:41', NULL, NULL, NULL),
(6, 1, 0, 'Analitica', NULL, 5, 1, 1, '2021-02-28 09:47:41', NULL, NULL, NULL),
(7, 1, 0, 'Colaborador', NULL, 6, 1, 1, '2021-02-28 09:47:41', NULL, NULL, NULL),
(8, 1, 0, 'Configracion', NULL, 7, 1, 1, '2021-02-28 09:47:41', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbmodulo_empresa`
--

CREATE TABLE `tbmodulo_empresa` (
  `id` int(11) NOT NULL,
  `empresa_id` int(11) NOT NULL,
...
INSERT INTO `tbmonedas` (`id`, `sigla`, `codigo`, `nombre`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 'S/', 'PEN', 'Sol', 1, 1, '2021-04-06 07:45:44', NULL, NULL, NULL),
(2, '$', 'USD', 'Dolar Estados unidos', 1, 1, '2021-04-06 07:34:08', NULL, NULL, NULL),
(3, 'E', 'EUR', 'Euro', 1, 1, '2021-04-06 07:34:08', NULL, NULL, NULL),
(4, 'sds', 'rdg', 'dfdf', 1, 1, '2021-04-06 07:34:08', NULL, NULL, NULL),
(5, 'edf', 'dfff', 'test', 1, 2, '2021-04-28 20:18:25', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbperfil_modulo`
--

CREATE TABLE `tbperfil_modulo` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `tbpresentacion` (
  ...
  `descripcion` int(199) DEFAULT NULL,
...
INSERT INTO `tbpresentacion` (`id`, `empresa_id`, `sigla`, `nombre`, `descripcion`, `enabled`, `fecha_on`, `userid_on`, `fecha_md`, `userid_md`, `fecha_del`) VALUES
(1, 2, 'niu', 'Unidad', NULL, 1, '2021-03-30 12:36:58', 1, NULL, NULL, NULL),
(2, 2, 'kg', 'Kilo Gramo', NULL, 1, '2021-03-30 12:36:58', 1, NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbproductoalmacen`
--

CREATE TABLE `tbproductoalmacen` (
  `id` int(11) NOT NULL,
  `empresa_id` int(11) NOT NULL,
  `almacen_id` int(11) NOT NULL,
  `producto_id` int(11) NOT NULL,
  `precio_venta_local` decimal(18,2) DEFAULT NULL,
  `stok_repo` int(11) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `tbproductoalmacen`
--

INSERT INTO `tbproductoalmacen` (`id`, `empresa_id`, `almacen_id`, `producto_id`, `precio_venta_local`, `stok_repo`, `stock`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 2, 1, 1, NULL, NULL, 10, 1, 1, '2021-04-05 23:22:12', NULL, NULL, NULL),
(2, 2, 1, 2, NULL, NULL, 20, 1, 1, '2021-04-05 23:22:12', NULL, NULL, NULL),
(3, 2, 2, 1, NULL, NULL, 21, 1, 1, '2021-04-05 23:22:12', NULL, NULL, NULL),
(4, 2, 2, 2, NULL, NULL, 12, 1, 1, '2021-04-05 23:22:12', NULL, NULL, NULL),
(5, 2, 3, 2, NULL, NULL, 11, 1, 1, '2021-04-05 23:22:12', NULL, NULL, NULL),
(6, 2, 1, 3, NULL, NULL, 9, 1, 1, '2021-04-05 23:22:12', NULL, NULL, NULL),
(7, 2, 1, 4, NULL, NULL, 16, 1, 1, '2021-04-05 23:22:12', NULL, NULL, NULL),
(8, 2, 1, 5, NULL, NULL, 10000, 1, 1, '2021-04-05 23:22:12', NULL, NULL, NULL),
(9, 2, 1, 6, NULL, NULL, 6, 1, 1, '2021-04-05 23:22:12', NULL, NULL, NULL),
(10, 2, 1, 7, NULL, NULL, 0, 1, 1, '2021-04-05 23:22:12', NULL, NULL, NULL),
(11, 2, 1, 8, NULL, NULL, 9, 1, 1, '2021-04-05 23:22:12', NULL, NULL, NULL),
(12, 2, 1, 9, NULL, NULL, 19, 1, 1, '2021-04-05 23:22:12', NULL, NULL, NULL),
(13, 2, 1, 10, NULL, NULL, 17, 1, 1, '2021-04-05 23:22:12', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbproductoimanges`
--

CREATE TABLE `tbproductoimanges` (
  `id` int(11) NOT NULL,
  `empresa_id` int(11) NOT NULL,
  `producto_id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `tbproductoimanges`
--

INSERT INTO `tbproductoimanges` (`id`, `empresa_id`, `producto_id`, `imagen`, `flag`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 2, 1, 'producto2.jpg', 1, 1, 1, '2021-04-01 19:22:20', NULL, NULL, NULL),
(2, 2, 2, 'producto1.jpg', 1, 1, 1, '2021-04-01 19:22:20', NULL, NULL, NULL),
(3, 2, 3, 'producto3.jpg', 1, 1, 1, '2021-04-01 19:22:20', NULL, NULL, NULL),
(4, 2, 4, NULL, 1, 1, 1, '2021-04-01 19:22:20', NULL, NULL, NULL),
(5, 2, 7, '20173424.PNG', 1, 1, 1, '2021-04-01 19:22:20', NULL, NULL, NULL),
(6, 2, 5, NULL, 1, 1, 1, '2021-04-01 19:22:20', NULL, NULL, NULL),
(7, 2, 6, NULL, 1, 1, 1, '2021-04-01 19:22:20', NULL, NULL, NULL),
(8, 2, 8, '20098648.PNG', 1, 1, 1, '2021-04-01 19:22:20', NULL, NULL, NULL),
(9, 2, 9, '126884.PNG', 1, 1, 1, '2021-04-01 19:22:20', NULL, NULL, NULL),
(10, 2, 10, '20120179.PNG', 1, 1, 1, '2021-04-01 19:22:20', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbproductoopciones`
--

CREATE TABLE `tbproductoopciones` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `tbproductos` (
  ...
  `especificaciontecnica` text DEFAULT NULL,
  ...
  `precioxmayor` decimal(18,2) DEFAULT NULL,
  `unidadmedida_id` int(11) NOT NULL,
  `impuesto` decimal(18,2) NOT NULL,
  `moneda_id` int(11) DEFAULT NULL,
  `perecible` tinyint(1) DEFAULT NULL,
  `fechaperecedor` datetime DEFAULT NULL,
...
INSERT INTO `tbproductos` (`id`, `empresa_id`, `sku`, `nombre`, `descripcion`, `caracteristicas`, `especificaciontecnica`, `categoria_id`, `subcategoria_id`, `marca_id`, `stock_min`, `precio_compra`, `precio_venta`, `precio_oferta`, `precioxmayor`, `unidadmedida_id`, `impuesto`, `moneda_id`, `perecible`, `fechaperecedor`, `Datas`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 2, '123456', 'cerveza pilsen', NULL, NULL, NULL, 2, 2, 1, 0, '0.00', '20.00', '0.00', NULL, 1, '18.00', 1, 0, NULL, NULL, 1, 1, '2021-04-02 02:52:33', NULL, NULL, NULL),
(2, 2, '123475', 'cerveza cusqueña', NULL, NULL, NULL, 2, 2, 2, 0, '0.00', '22.00', '12.00', NULL, 1, '18.00', 1, 0, NULL, NULL, 1, 1, '2021-04-02 02:52:33', NULL, NULL, NULL),
(3, 2, '123477', 'cerveza cristal', NULL, NULL, NULL, 2, 2, 3, 0, '0.00', '19.00', '0.00', NULL, 1, '18.00', 1, 0, NULL, NULL, 1, 1, '2021-04-02 02:52:33', NULL, NULL, NULL),
(4, 2, '123478', 'cerveza trujillo', NULL, NULL, NULL, 2, 2, 4, 0, '0.00', '16.00', '13.00', NULL, 1, '18.00', 1, 0, NULL, NULL, 1, 1, '2021-04-02 02:52:33', NULL, NULL, NULL),
(5, 2, '641425', 'arroz costoño', 'arroz costoño', 'Arroz Extra COSTEÑO Bolsa 5Kg', NULL, 1, 1, 6, 0, '0.00', '18.00', '0.00', NULL, 1, '18.00', 1, 0, NULL, NULL, 1, 1, '2021-04-02 02:52:33', NULL, NULL, NULL),
(6, 2, '20139617', 'Arroz Extra', 'Arroz Extra Bolsa 5kg', NULL, NULL, 2, 2, 4, 0, '0.00', '20.20', '100.00', NULL, 1, '18.00', 1, 0, NULL, NULL, 1, 1, '2021-04-02 02:52:33', NULL, NULL, NULL),
(7, 2, '20173424', 'Filete de Atún FLORIDA', 'Filete de Atún FLORIDA en Aceite de Girasol Lata 170g', NULL, NULL, 2, 2, 4, 0, '0.00', '5.49', '5.29', NULL, 1, '18.00', 1, 0, NULL, NULL, 1, 1, '2021-04-02 02:52:33', NULL, NULL, NULL),
(8, 2, '20098648', 'Spaghetti DON VITTORIO', 'Spaghetti DON VITTORIO Bolsa 1Kg', NULL, NULL, 2, 2, 4, 0, '0.00', '4.40', '0.00', NULL, 1, '18.00', 1, 0, NULL, NULL, 1, 1, '2021-04-02 02:52:33', NULL, NULL, NULL),
(9, 2, '126884', 'Agua Mineral SAN LUIS', 'Agua Mineral SAN LUIS Con Gas Botella 625ml', NULL, NULL, 2, 2, 4, 0, '0.00', '1.50', '0.00', NULL, 1, '18.00', 1, 0, NULL, NULL, 1, 1, '2021-04-02 02:52:33', NULL, NULL, NULL),
(10, 2, '20120179', 'Papel Toalla NOVA Clásico', 'Papel Toalla NOVA Clásico Mega Rollo Paquete 2un', NULL, NULL, 2, 2, 4, 0, '0.00', '5.80', '0.00', NULL, 1, '18.00', 1, 0, NULL, NULL, 1, 1, '2021-04-02 02:52:33', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbproductovendedor`
--

CREATE TABLE `tbproductovendedor` (
  `id` int(11) NOT NULL,
  `empresa_id` int(11) NOT NULL,
  `user_id` int(11) NOT NULL,
  `producto_id` int(11) NOT NULL,
  `almacen_id` int(11) DEFAULT NULL,
  `color` varchar(12) DEFAULT '#EAF0E2',
  `enabled` tinyint(1) DEFAULT 1,
  `userid_on` int(11) NOT NULL,
  `fecha_on` datetime NOT NULL,
  `userid_md` int(11) DEFAULT NULL,
...
--
-- Volcado de datos para la tabla `tbproductovendedor`
--

INSERT INTO `tbproductovendedor` (`id`, `empresa_id`, `user_id`, `producto_id`, `almacen_id`, `color`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 2, 2, 5, 1, '#EAF0E2', 1, 2, '2021-04-20 02:48:30', 2, '2021-04-20 02:55:07', '2021-04-20 02:54:55'),
(2, 2, 2, 1, 1, '#EAF0E2', 1, 2, '2021-04-20 02:48:50', NULL, NULL, NULL),
(3, 2, 2, 2, 1, '#EAF0E2', 1, 2, '2021-04-20 02:54:37', 2, '2021-04-20 10:16:07', '2021-04-20 10:15:58'),
(4, 2, 2, 7, 1, '#EAF0E2', 1, 2, '2021-04-20 10:17:37', NULL, NULL, NULL),
(5, 2, 2, 8, 1, '#EAF0E2', 1, 2, '2021-04-20 10:17:38', NULL, NULL, NULL),
(6, 2, 2, 9, 1, '#EAF0E2', 1, 2, '2021-04-20 10:17:39', NULL, NULL, NULL),
(7, 2, 2, 3, 1, '#EAF0E2', 1, 2, '2021-04-20 10:17:41', NULL, NULL, NULL);
...
--
-- Estructura de tabla para la tabla `tbprovincias`
--
...
--
-- Volcado de datos para la tabla `tbprovincias`
--

INSERT INTO `tbprovincias` (`id`, `name`, `departamento_id`) VALUES
('0101', 'Chachapoyas', '01'),
('0102', 'Bagua', '01'),
('0103', 'Bongará', '01'),
...
INSERT INTO `tbsubcategoria` (`id`, `empresa_id`, `categoria_id`, `nombre`, `descripcion`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 2, 1, 'arroz', NULL, 1, 1, '2021-03-29 23:07:48', NULL, NULL, NULL),
(2, 2, 2, 'cerveza', NULL, 1, 1, '2021-03-29 23:07:48', NULL, NULL, NULL),
(3, 2, 3, 'test1', 'test', 1, 2, '2021-04-26 01:55:26', 2, '2021-04-26 01:55:38', NULL);
...
INSERT INTO `tbtienda` (`id`, `empresa_id`, `nombre`, `direccion`, `telefono`, `email`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 2, 'Tienda1', NULL, NULL, NULL, 1, 1, '2021-04-02 16:59:17', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbtiposcambio`
--

CREATE TABLE `tbtiposcambio` (
  `id` int(11) NOT NULL,
  `empresa_id` int(11) NOT NULL,
  `moneda_id` int(11) NOT NULL,
...
--
-- Volcado de datos para la tabla `tbtiposcambio`
--

INSERT INTO `tbtiposcambio` (`id`, `empresa_id`, `moneda_id`, `fechatc`, `venta`, `compra`, `promedio`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 2, 2, '2021-04-06', '3.7200', '3.7100', '3.7200', 1, 1, '2021-04-06 08:01:35', NULL, NULL, NULL),
(2, 2, 2, '2021-04-20', '3.6300', '3.6200', '3.6300', 1, 1, '2021-04-20 08:01:35', NULL, NULL, NULL);
...
CREATE TABLE `tbusuarios` (
  ...
  `tockend` varchar(191) DEFAULT NULL,
...
INSERT INTO `tbusuarios` (`id`, `perfil_id`, `name`, `correo`, `password`, `tockend`, `tienda_id`, `flag`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, NULL, 'sistemas', 'ronald1781@outlook.com', 'abc123', NULL, NULL, 0, 1, 1, '2021-02-28 10:15:50', NULL, NULL, NULL),
(2, NULL, 'empresa user', 'ronald1781@gmail.com', 'abc123', NULL, 1, 1, 1, 1, '2021-02-28 10:15:50', NULL, NULL, NULL);
...
INSERT INTO `tbusuario_empresa` (`id`, `usuario_id`, `empresa_id`, `enabled`, `userid_on`, `fecha_on`, `userid_md`, `fecha_md`, `fecha_del`) VALUES
(1, 2, 2, 1, 1, '2021-03-05 23:36:57', NULL, NULL, NULL);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `tbventascab`
--

CREATE TABLE `tbventascab` (
  `id` int(11) NOT NULL,
  `empresa_id` int(11) NOT NULL,
  ...
  `provincia_code` varchar(4) DEFAULT NULL,
  `distrito_code` varchar(6) DEFAULT NULL,
  `tipoafectacion_id` int(11) DEFAULT NULL,
  `importe` decimal(8,2) DEFAULT NULL,
  `impuesto` decimal(8,2) DEFAULT NULL,
  `total` decimal(8,2) DEFAULT NULL,
  `descuento` decimal(8,2) DEFAULT NULL,
  ...
  `almacen_id` int(11) DEFAULT NULL,
  `ref_tipocomprobante_id` int(11) DEFAULT NULL,
  `ref_serie_comprobante` varchar(5) DEFAULT NULL,
  `ref_numero_comprobante` varchar(15) DEFAULT NULL,
  `ref_fecha_emision` date DEFAULT NULL,
  `enabled` tinyint(1) DEFAULT 1,
  `userid_on` int(11) NOT NULL,
  `fecha_on` datetime NOT NULL,
  `userid_md` int(11) DEFAULT NULL,
...
--
-- Estructura de tabla para la tabla `tbventasdet`
--

CREATE TABLE `tbventasdet` (
  `id` int(11) NOT NULL,
  `empresa_id` int(11) NOT NULL,
  `venta_id` int(11) NOT NULL,
  `tipoafectacion_id` int(11) NOT NULL,
  `producto_id` int(11) NOT NULL,
  `unidad_medida_id` int(11) NOT NULL,
  `nombre` varchar(120) DEFAULT NULL,
  `sku` varchar(45) DEFAULT NULL,
  ...
  `precio_unitario` decimal(8,2) DEFAULT NULL,
  `precio` decimal(8,2) DEFAULT NULL,
  `formadscto` char(1) DEFAULT NULL,
  `descuento` decimal(8,2) DEFAULT NULL,
  `impuesto` decimal(8,2) DEFAULT NULL,
  `total` decimal(8,2) DEFAULT NULL,
  `enabled` tinyint(1) DEFAULT 1,
...
--
-- Indices de la tabla `tbbasicos`
--
ALTER TABLE `tbbasicos`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tbcajasdet`
--
ALTER TABLE `tbcajasdet`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tbclientemodalidadpago`
--
ALTER TABLE `tbclientemodalidadpago`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tbcomprascab`
--
ALTER TABLE `tbcomprascab`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tbcomprasdet`
--
ALTER TABLE `tbcomprasdet`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tbdistritos`
--
ALTER TABLE `tbdistritos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tbempresamonedas`
--
ALTER TABLE `tbempresamonedas`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tbgenerales`
--
ALTER TABLE `tbgenerales`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tbgestorsoft`
--
ALTER TABLE `tbgestorsoft`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tbinventariocab`
--
ALTER TABLE `tbinventariocab`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tbinventariodet`
--
ALTER TABLE `tbinventariodet`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tbmodulos`
--
ALTER TABLE `tbmodulos`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tbmodulo_empresa`
--
ALTER TABLE `tbmodulo_empresa`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tbperfil_modulo`
--
ALTER TABLE `tbperfil_modulo`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tbproductoalmacen`
--
ALTER TABLE `tbproductoalmacen`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tbproductoimanges`
--
ALTER TABLE `tbproductoimanges`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tbproductoopciones`
--
ALTER TABLE `tbproductoopciones`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tbproductovendedor`
--
ALTER TABLE `tbproductovendedor`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tbprovincias`
--
...
--
-- Indices de la tabla `tbtiposcambio`
--
ALTER TABLE `tbtiposcambio`
  ADD PRIMARY KEY (`id`);
...
--
-- Indices de la tabla `tbventascab`
--
ALTER TABLE `tbventascab`
  ADD PRIMARY KEY (`id`);

--
-- Indices de la tabla `tbventasdet`
--
ALTER TABLE `tbventasdet`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `tbbasicos`
--
ALTER TABLE `tbbasicos`
...
--
-- AUTO_INCREMENT de la tabla `tbcajasdet`
--
ALTER TABLE `tbcajasdet`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `tbcolaboradores`
--
ALTER TABLE `tbcolaboradores`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `tbcomprascab`
--
ALTER TABLE `tbcomprascab`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tbcomprasdet`
--
ALTER TABLE `tbcomprasdet`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tbempresamonedas`
--
ALTER TABLE `tbempresamonedas`
...
--
-- AUTO_INCREMENT de la tabla `tbgenerales`
--
ALTER TABLE `tbgenerales`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tbgestorsoft`
--
ALTER TABLE `tbgestorsoft`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `tbinventariocab`
--
ALTER TABLE `tbinventariocab`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tbinventariodet`
--
ALTER TABLE `tbinventariodet`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `tblicencia`
--
ALTER TABLE `tblicencia`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `tbmodulos`
--
ALTER TABLE `tbmodulos`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `tbmodulo_empresa`
--
ALTER TABLE `tbmodulo_empresa`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `tbpresentacion`
--
ALTER TABLE `tbpresentacion`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `tbproductoalmacen`
--
ALTER TABLE `tbproductoalmacen`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `tbproductoimanges`
--
ALTER TABLE `tbproductoimanges`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `tbproductoopciones`
--
ALTER TABLE `tbproductoopciones`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT de la tabla `tbproductovendedor`
--
ALTER TABLE `tbproductovendedor`
...
--
-- AUTO_INCREMENT de la tabla `tbtienda`
--
ALTER TABLE `tbtienda`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `tbtiposcambio`
--
ALTER TABLE `tbtiposcambio`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT de la tabla `tbventascab`
--
ALTER TABLE `tbventascab`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `tbventasdet`
--
ALTER TABLE `tbventasdet`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
